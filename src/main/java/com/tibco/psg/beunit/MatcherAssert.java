...
public class MatcherAssert {
	...
	public static void assertThat(String reason, Object actual, Object matcher) {
		org.hamcrest.MatcherAssert.assertThat(reason, actual, (Matcher) matcher);
	}
    ...
    @com.tibco.be.model.functions.BEFunction(
		...
		version = "1.0", see = "", mapper = @com.tibco.be.model.functions.BEMapper(), 
		cautions = "none", fndomain = { ACTION }, example = "asList(Object[]{&quot;abc&quot;, &quot;xyz&quot;})")
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public static Object everyItem(
			Object itemMatcher) {
	...
	/**
	 * A shortcut to the frequently used <code>not(equalTo(x))</code>. For
	 * example:
	 * 
	 * <pre>
